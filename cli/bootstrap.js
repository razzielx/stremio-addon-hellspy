...
async function createAddon() {
  ...
  const userInput = await inquirer.prompt([
    ...
    },
    {
      ...
      name: "resources",
      choices: [{ name: "catalog" }, { name: "stream" }, { name: "meta" }, { name: "subtitles" }],
    },
    {
      type: "checkbox",
      message: "Select the types that your addon provides",
      name: "types",
      choices: [{ name: "movie" }, { name: "series" }, { name: "channel" }, { name: "tv" }],
    },
  ]);

  if (
    !userInput.resources.includes("meta") &&
    !userInput.resources.includes("subtitles") &&
    !userInput.types.includes("channel") &&
    !userInput.types.includes("tv")
  ) {
